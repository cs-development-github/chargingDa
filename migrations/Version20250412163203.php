 ...
 */
final class Version20250412163203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE charging_stations (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT NOT NULL, model VARCHAR(255) NOT NULL, connectors INT NOT NULL, image VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_CBDA0A93989D9B62 (slug), INDEX IDX_CBDA0A93A23B42D (manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, installator_id INT DEFAULT NULL, charging_station_id INT DEFAULT NULL, sim VARCHAR(255) NOT NULL, borne_name VARCHAR(255) DEFAULT NULL, INDEX IDX_D11814AB19EB6921 (client_id), INDEX IDX_D11814ABE71A9910 (installator_id), INDEX IDX_D11814AB34D723C9 (charging_station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tarification (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, charging_station_id INT DEFAULT NULL, purcharse_price VARCHAR(255) NOT NULL, resale_price VARCHAR(255) NOT NULL, reduced_price VARCHAR(255) NOT NULL, public_price VARCHAR(255) DEFAULT NULL, fixed_fee_public VARCHAR(255) DEFAULT NULL, recharge_time_public VARCHAR(255) DEFAULT NULL, parking_time_public VARCHAR(255) DEFAULT NULL, fixed_fee_resale VARCHAR(255) DEFAULT NULL, recharge_time_resale VARCHAR(255) DEFAULT NULL, parking_time_resale VARCHAR(255) DEFAULT NULL, INDEX IDX_613281619EB6921 (client_id), INDEX IDX_613281634D723C9 (charging_station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
